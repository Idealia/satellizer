    ...
    var OAuth2 = (function () {
        ...
        OAuth2.prototype.init = function (options, userData) {
            ...
            return this.$q(function (resolve, reject) {
                ...
                var _a = _this.defaults, name = _a.name, state = _a.state, popupOptions = _a.popupOptions, redirectUri = _a.state && _this.defaults.name === 'google' ? _a.state : _a.redirectUri, responseType = _a.responseType;
